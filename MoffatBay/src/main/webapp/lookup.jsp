	...
	<div class="container">
		<div class="center-container">	
			...
			<div class="grid-container">
				...
				<label for="roomSize" id="roomLabel" style="font-size: 18px;">Room Size:</label>
				<div id="roomSize"><c:out value="${roomSize}"/></div><br>
				
				<label for="numGuests" id="guestsLabel" style="font-size: 18px;">Number of Guests:</label>
				<div id="numGuests"><c:out value="${numGuests}"/></div><br>
				
				<label for="inDate" id="inDateLabel" style="font-size: 18px;">Check-in Date:</label>
				<div id="inDate"><c:out value="${inDate}"/></div><br>
				
				<label for="outDate" id="outDateLabel" style="font-size: 18px;">Check-out:</label>
				...
				<form action="/MoffatBay/lookup" method="get">
					...
					<c:if test="${current > 0}">
					<input type="submit" id="clearButton" value="New Search" name="clear" class="button">
					</c:if>
				</form>
