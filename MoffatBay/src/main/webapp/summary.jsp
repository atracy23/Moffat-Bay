...
<meta charset="ISO-8859-1">
 <meta charset="UTF-8">
    ...
    <script src="https://code.jquery.com/ui/1.10.4/jquery-ui.js"></script>      <title>About Us</title>
	<style>
...
<!-- 		    <p>Room Size: ${reserveSummary.roomSize}</p>
 ...
 -->
 			<p>Room Size:</p><p> ${reserveSummary.roomSize}</p><br>
 			<p>Number of Guests:</p><p> ${reserveSummary.numGuests}</p><br>
		    <p>Check-in Date:</p><p> ${reserveSummary.inDate}</p><br>
		    <p>Check-out Date:</p><p> ${reserveSummary.outDate}</p><br>
		    <p>Total Price:</p><p> $${reserveSummary.price}</p><br>
