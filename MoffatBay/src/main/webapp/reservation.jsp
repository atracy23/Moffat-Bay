		...
		<%@ page import="java.text.SimpleDateFormat" %>
        	...
        	int double_full_max = 4;
         	...
         	int numGuests = getElementById("numGuests").value;
														...
														if (answer == false) {
															$.post('reservation.jsp'), {
																roomSizeError: "The size of room selected does not support the number of guests chosen.  Please select room size that will accommodate the number of guests chosen.""}
         	}
														}
																	...
																	<div class="grid-container">
																		...
																		<div class="item1">
																			...
																			<select style="display: table-cell;"
																				...
																				required>
																				<option value=""> </option>
																				<option value="1" ${param.numGuests=='1'
																					? 'selected' : '' }>1</option>
																				<option value="2" ${param.numGuests=='2'
																					? 'selected' : '' }>2</option>
																				<option value="3" ${param.numGuests=='3'
																					? 'selected' : '' }>3</option>
																				<option value="4" ${param.numGuests=='4'
																					? 'selected' : '' }>4</option>
																				<option value="5" ${param.numGuests=='5'
																					? 'selected' : '' }>5</option>
																			</select>
																		</div>
																		<!-- roomSize Form -->
																		<div class="item2">
																			<label for="roomSize">Select room size
																				(Double Full, Queen, Double Queen,
																				King):*</label>
																			<select id="roomSize" name="roomSize"
																				value="${param.roomSize}"
																				onchange="return roomSizeError();"
																				required>
																				<option value=""> </option>
																				<option value="Double Full"
																					${param.roomSize=='Double Full'
																					? 'selected' : '' }>Double Full Beds
																					(Guests 1-4)</option>
																				<option value="Queen"
																					${param.roomSize=='Queen'
																					? 'selected' : '' }>Queen Bed
																					(Guests 1-2)</option>
																				<option value="Double Queen"
																					${param.roomSize=='Double Queen'
																					? 'selected' : '' }>Double Queen
																					Beds (Guests 1-5)</option>
																				<option value="King"
																					${param.roomSize=='King'
																					? 'selected' : '' }>King Bed (Guests
																					1-3)</option>
																			</select>
																		...
																		<div class="item4">
																			<p>Select your Check-in Date (type in Date
																				year/month/day or use drop-down
																				calendar):* <input type="text"
																					id="datepick-1" name="inDate"
																					value="${param.inDate}"
																					onchange="hideError()" required></p>
																		</div>

																		<!-- Check-out Form -->
																		<div class="item5">
																			<p>Select your Check-out Date (type in Date
																				year/month/day or use drop-down
																				calendar):* <input type="text"
																					id="datepick-3" name="outDate"
																					value="${param.outDate}"
																					onchange="hideError()" required></p>
																		</div>
																		...
																		<c:if test="${noAvailableRooms!=null}">
																			<div class="item6">
																				<h3 id="error_message"
																					style="color: red; font-size: medium; content: flex;">
																					${noAvailableRooms}</h3>
																			</div>
																		</c:if>
																	</div>
												...
												<footer>
													<div class="footer-content">
														...
														<div class="footer-section">
															...
															<h3>About Us</h3>
															<ul>
																<li><a href="Aboutus.jsp">Discover the beauty of Moffat
																		Bay Resort, where nature meets
																		luxury.</a></li>
															</ul>
														...
														<div class="footer-section">
															<h3>Attractions</h3>
															<ul>
																<li><a href="attractions.html">Check Out What We have to
																		Offer!</a></li>
