<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
    ...
    <body>
        ...
        <div class="active-container">
            <p class="active">Indulge in the ultimate getaway at Moffat Bay, where nature's finest offerings converge in
                perfect harmony. Nestled between majestic mountains and the tranquil embrace of the ocean, Moffat Bay
                promises an enchanting escape that seamlessly blends the allure of both worlds.</p>
        </div>
